...
class _ProductPageState extends State<ProductPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        bottomNavigationBar: Consumer<ProductNotifier>(
          builder: (context, productNotifier, child) {
            return Padding(
              ...
              child: CheckoutButton(
                onTap: () async {
                  // _createCart({
                  //   "id": widget.id,
                  //   "name": productNotifier.sneaker.name,
                  //   "category": productNotifier.sneaker.category,
                  //   "sizes": productNotifier.sizes[0],
                  //   "imageUrl": productNotifier.sneaker.imageUrl[0],
                  //   "price": productNotifier.sneaker.price,
                  //   "qty": 1
                  // });
                  // print(productNotifier.sneaker.name);
